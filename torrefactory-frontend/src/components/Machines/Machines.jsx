            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '15px' }}>
                ...
                <input type="text" value={formData.nom}
                  ...
                  required placeholder="ex: Torréfacteur Principal" style={inputStyle} />
              </div>
              ...
              <div style={{ marginBottom: '15px' }}>
                ...
                <input type="text" value={formData.numeroSerie}
                  onChange={(e) => setFormData({...formData, numeroSerie: e.target.value})}
                  required placeholder="ex: SN-2026-001" style={inputStyle} />
              </div>

              <div style={{ marginBottom: '15px' }}>
                <label style={{ color: '#d4a574', display: 'block', marginBottom: '5px' }}>Capacité (kg/h)</label>
                <input type="number" value={formData.capacite}
                  onChange={(e) => setFormData({...formData, capacite: e.target.value})}
                  required min="1" placeholder="ex: 100" style={inputStyle} />
              </div>
